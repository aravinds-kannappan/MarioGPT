...
def compute_T_score(collector: MetricsCollector,
    ...
    # Default configuration (from framework Section 4.2)
    if config is None:
        config = {
    ...
    # 4. Time to Complete Score (inverted: faster = better)
    ...
    # 5. Progress Variance Score (inverted: consistent = better)
